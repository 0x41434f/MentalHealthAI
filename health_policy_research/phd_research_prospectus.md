...
My research methodology is grounded in my direct and ongoing **exposure to the American psychiatric healthcare system and its clinical practices**. This long-term observational and ethnographic study is conducted across several different clinical services, including an **inpatient unit**, the **psychiatric emergency room**, and a **child and adolescent psychiatry service**. This frontline work provides a ground-level view of the system's crisis: a default to "trial-and-error" treatment, immense administrative waste that burns out clinicians, and a structure that ultimately fails the complex patients it is meant to serve. This is the critical health policy problem my research will address.
